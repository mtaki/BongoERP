...
/**
 * CbCurrenceSearch represents the model behind the search form about `app\modules\setting\models\CbCurrence`.
 */
class CbCurrenceSearch extends CbCurrence
{
    /**
     * @inheritdoc
     */
