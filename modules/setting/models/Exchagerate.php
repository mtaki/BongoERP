 ...
 */
class Exchagerate extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return ExchagerateQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new ExchagerateQuery(get_called_class());
    }
}
