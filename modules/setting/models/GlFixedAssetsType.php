 ...
 */
class GlFixedAssetsType extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    /**
     * @inheritdoc
     * @return GlFixedAssetsTypeQuery the active query used by this AR class.
     */
    public static function find()
    {
        return new GlFixedAssetsTypeQuery(get_called_class());
    }
}
