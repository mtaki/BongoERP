...
use app\modules\setting\Models\VendorTypeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * VendortyperController implements the CRUD actions for VendorType model.
 */
class VendortyperController extends Controller
{
