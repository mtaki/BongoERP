...
use app\modules\setting\Models\CustomerTypeSearch;
use yii\web\Controller;
use yii\web\NotFoundHttpException;
use yii\filters\VerbFilter;

/**
 * CustomertypeZoneController implements the CRUD actions for CustomerType model.
 */
class CustomertypeZoneController extends Controller
{
