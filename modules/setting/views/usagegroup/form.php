...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create usagegroup</h3>
            </div>
            <div class="porlets-content">
            <form  name="usagegroup-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Id</label>
                  	<div class="col-sm-9"><input type="text" name="id" ng-model="usagegroup.id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Name</label>
                  	<div class="col-sm-9"><input type="text" name="name" ng-model="usagegroup.name"class="form-control"></div>
                	</div><!--/form-group-->
