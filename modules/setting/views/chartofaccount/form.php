...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create chart-of-account</h3>
            </div>
            <div class="porlets-content">
            <form  name="chart-of-account-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Id</label>
                  	<div class="col-sm-9"><input type="text" name="id" ng-model="chart-of-account.id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Account no</label>
                  	<div class="col-sm-9"><input type="text" name="account_no" ng-model="chart-of-account.account_no"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Account name</label>
                  	<div class="col-sm-9"><input type="text" name="account_name" ng-model="chart-of-account.account_name"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Gl account coa parent id</label>
                  	<div class="col-sm-9"><input type="text" name="gl_account_coa_parent_id" ng-model="chart-of-account.gl_account_coa_parent_id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Status</label>
                  	<div class="col-sm-9"><input type="text" name="status" ng-model="chart-of-account.status"class="form-control"></div>
                	</div><!--/form-group-->
