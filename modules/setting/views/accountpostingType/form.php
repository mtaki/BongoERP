		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
            ...
            <form  name="account-posting-type-form" class="form-horizontal row-border">
					...
					<div class="form-group">
                  	...
                  	<div class="col-sm-9"><input type="text" name="Doc_type_code" ng-model="account-posting-type.Doc_type_code"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Doc type code description</label>
                  	<div class="col-sm-9"><input type="text" name="Doc_type_code_description" ng-model="account-posting-type.Doc_type_code_description"class="form-control"></div>
                	</div><!--/form-group-->
