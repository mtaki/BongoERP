		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
            ...
            <form  name="company-setup-form" class="form-horizontal row-border">
					...
					<div class="form-group">
                  	...
                  	<div class="col-sm-9"><input type="text" name="Parameter_ID" ng-model="company-setup.Parameter_ID"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">CompanyName</label>
                  	<div class="col-sm-9"><input type="text" name="CompanyName" ng-model="company-setup.CompanyName"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Company abreviation</label>
                  	<div class="col-sm-9"><input type="text" name="Company_abreviation" ng-model="company-setup.Company_abreviation"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">PostalAddress</label>
                  	<div class="col-sm-9"><input type="text" name="PostalAddress" ng-model="company-setup.PostalAddress"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Residence</label>
                  	<div class="col-sm-9"><input type="text" name="Residence" ng-model="company-setup.Residence"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">PhoneAndFax</label>
                  	<div class="col-sm-9"><input type="text" name="PhoneAndFax" ng-model="company-setup.PhoneAndFax"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">EmailAndWebsite</label>
                  	<div class="col-sm-9"><input type="text" name="EmailAndWebsite" ng-model="company-setup.EmailAndWebsite"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">CompanyLogo</label>
                  	<div class="col-sm-9"><input type="text" name="CompanyLogo" ng-model="company-setup.CompanyLogo"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">ReportFooter</label>
                  	<div class="col-sm-9"><input type="text" name="ReportFooter" ng-model="company-setup.ReportFooter"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Default currency</label>
                  	<div class="col-sm-9"><input type="text" name="default_currency" ng-model="company-setup.default_currency"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Current value per share</label>
                  	<div class="col-sm-9"><input type="text" name="current_value_per_share" ng-model="company-setup.current_value_per_share"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Loan computation method</label>
                  	<div class="col-sm-9"><input type="text" name="loan_computation_method" ng-model="company-setup.loan_computation_method"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Monthly rate for Basic method</label>
                  	<div class="col-sm-9"><input type="text" name="monthly_rate_for_Basic_method" ng-model="company-setup.monthly_rate_for_Basic_method"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Chairman</label>
                  	<div class="col-sm-9"><input type="text" name="chairman" ng-model="company-setup.chairman"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Secretary</label>
                  	<div class="col-sm-9"><input type="text" name="secretary" ng-model="company-setup.secretary"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Treasurer</label>
                  	<div class="col-sm-9"><input type="text" name="treasurer" ng-model="company-setup.treasurer"class="form-control"></div>
                	</div><!--/form-group-->
