...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
            ...
            <form  name="region-form" class="form-horizontal row-border">
			...
			<div class="form-group">
                  	...
                  	<div class="col-sm-9">
					<input type="text" name="Region_Name" class="form-control"></div>
                	</div><!--/form-group-->
 ...
 <?php $form = ActiveForm::begin(); ?>
           ...
           <div class="col-sm-9">
				...
				<?= $form->field($model,'Region_Name')->textInput(['maxlength' => true])->label('') ?>
