...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create exchagerate</h3>
            </div>
            <div class="porlets-content">
            <form  name="exchagerate-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Currency code</label>
                  	<div class="col-sm-9"><input type="text" name="currency_code" ng-model="exchagerate.currency_code"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Exchange rate</label>
                  	<div class="col-sm-9"><input type="text" name="exchange_rate" ng-model="exchagerate.exchange_rate"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Rate decimal</label>
                  	<div class="col-sm-9"><input type="text" name="rate_decimal" ng-model="exchagerate.rate_decimal"class="form-control"></div>
                	</div><!--/form-group-->
