...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create purchase-type</h3>
            </div>
            <div class="porlets-content">
            <form  name="purchase-type-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Id</label>
                  	<div class="col-sm-9"><input type="text" name="id" ng-model="purchase-type.id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Purchase type</label>
                  	<div class="col-sm-9"><input type="text" name="purchase_type" ng-model="purchase-type.purchase_type"class="form-control"></div>
                	</div><!--/form-group-->
