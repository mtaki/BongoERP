...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create loan-type</h3>
            </div>
            <div class="porlets-content">
            <form  name="loan-type-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Id</label>
                  	<div class="col-sm-9"><input type="text" name="id" ng-model="loan-type.id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Loan type</label>
                  	<div class="col-sm-9"><input type="text" name="loan_type" ng-model="loan-type.loan_type"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Interest rate</label>
                  	<div class="col-sm-9"><input type="text" name="interest_rate" ng-model="loan-type.interest_rate"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Description</label>
                  	<div class="col-sm-9"><input type="text" name="description" ng-model="loan-type.description"class="form-control"></div>
                	</div><!--/form-group-->
