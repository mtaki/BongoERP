		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
            ...
            <form  name="district-form" class="form-horizontal row-border">
					...
					<div class="form-group">
                  	...
                  	<div class="col-sm-9"><input type="text" name="District_Id" ng-model="district.District_Id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Region Id</label>
                  	<div class="col-sm-9"><input type="text" name="Region_Id" ng-model="district.Region_Id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">District Name</label>
                  	<div class="col-sm-9"><input type="text" name="District_Name" ng-model="district.District_Name"class="form-control"></div>
                	</div><!--/form-group-->
