...
<?php $form = ActiveForm::begin(["class"=>"form-horizontal row-border"]); ?>
		   ...
		   <label class="col-sm-2 control-label">Region Id</label>
           <div class="col-sm-4">
			<?= $form->field($model,'Region_Id')->textInput(['maxlength' => true])->label('') ?>			</div>
		</div><!--/form-group-->
				
			 <div class="form-group">
		   <label class="col-sm-2 control-label">District Name</label>
           <div class="col-sm-4">
			<?= $form->field($model,'District_Name')->textInput(['maxlength' => true])->label('') ?>			</div>
		</div><!--/form-group-->
