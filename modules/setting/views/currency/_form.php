...
<?php $form = ActiveForm::begin(["class"=>"form-horizontal row-border"]); ?>
           ...
           <div class="col-sm-4">
			<?= $form->field($model,'currency_code')->textInput(['maxlength' => true])->label('') ?>			</div>
			 ...
			 <div class="form-group">
		   <label class="col-sm-2 control-label">Currency country</label>
           <div class="col-sm-4">
			<?= $form->field($model,'currency_country')->textInput(['maxlength' => true])->label('') ?>			</div>
		</div><!--/form-group-->
				
			 <div class="form-group">
		   <label class="col-sm-2 control-label">Currency name</label>
           <div class="col-sm-4">
			<?= $form->field($model,'currency_name')->textInput(['maxlength' => true])->label('') ?>			</div>
		</div><!--/form-group-->
