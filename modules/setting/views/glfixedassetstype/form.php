...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create gl-fixed-assets-type</h3>
            </div>
            <div class="porlets-content">
            <form  name="gl-fixed-assets-type-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Sub ledger no</label>
                  	<div class="col-sm-9"><input type="text" name="sub_ledger_no" ng-model="gl-fixed-assets-type.sub_ledger_no"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Name</label>
                  	<div class="col-sm-9"><input type="text" name="name" ng-model="gl-fixed-assets-type.name"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Remarks</label>
                  	<div class="col-sm-9"><input type="text" name="remarks" ng-model="gl-fixed-assets-type.remarks"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Mapped gl account</label>
                  	<div class="col-sm-9"><input type="text" name="mapped_gl_account" ng-model="gl-fixed-assets-type.mapped_gl_account"class="form-control"></div>
                	</div><!--/form-group-->
