      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
			...
			<div class="form-group">
                  	...
                  	<div class="col-sm-9">
					<input type="text" name="account_parent_code" class="form-control"></div>
                	</div><!--/form-group-->
			...
			<div class="form-group">
                  	...
                  	<div class="col-sm-9">
					<input type="text" name="gl_account_coa_grand_parent_id" class="form-control"></div>
                	</div><!--/form-group-->
			...
			<div class="form-group">
                  	...
                  	<div class="col-sm-9">
					<input type="text" name="parent_name" class="form-control"></div>
                	</div><!--/form-group-->
