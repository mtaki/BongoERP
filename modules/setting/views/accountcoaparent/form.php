...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create account-coa-parent</h3>
            </div>
            <div class="porlets-content">
            <form  name="account-coa-parent-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Id</label>
                  	<div class="col-sm-9"><input type="text" name="id" ng-model="account-coa-parent.id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Account parent code</label>
                  	<div class="col-sm-9"><input type="text" name="account_parent_code" ng-model="account-coa-parent.account_parent_code"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Gl account coa grand parent id</label>
                  	<div class="col-sm-9"><input type="text" name="gl_account_coa_grand_parent_id" ng-model="account-coa-parent.gl_account_coa_grand_parent_id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Parent name</label>
                  	<div class="col-sm-9"><input type="text" name="parent_name" ng-model="account-coa-parent.parent_name"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Remarks</label>
                  	<div class="col-sm-9"><input type="text" name="Remarks" ng-model="account-coa-parent.Remarks"class="form-control"></div>
                	</div><!--/form-group-->
