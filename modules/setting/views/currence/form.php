...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create currence</h3>
            </div>
            <div class="porlets-content">
            <form  name="currence-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Id</label>
                  	<div class="col-sm-9"><input type="text" name="id" ng-model="currence.id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Currency code</label>
                  	<div class="col-sm-9"><input type="text" name="currency_code" ng-model="currence.currency_code"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Currency country</label>
                  	<div class="col-sm-9"><input type="text" name="currency_country" ng-model="currence.currency_country"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Currency name</label>
                  	<div class="col-sm-9"><input type="text" name="currency_name" ng-model="currence.currency_name"class="form-control"></div>
                	</div><!--/form-group-->
