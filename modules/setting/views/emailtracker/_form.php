...
<?php $form = ActiveForm::begin(["class"=>"form-horizontal row-border"]); ?>
           ...
           <div class="col-sm-4">
			<?= $form->field($model,'sender')->textInput(['maxlength' => true])->label('') ?>			</div>
		</div><!--/form-group-->
				
			 <div class="form-group">
		   <label class="col-sm-2 control-label">Receiver</label>
           <div class="col-sm-4">
			<?= $form->field($model,'receiver')->textInput(['maxlength' => true])->label('') ?>			</div>
		</div><!--/form-group-->
				
			 <div class="form-group">
		   <label class="col-sm-2 control-label">Subject</label>
           <div class="col-sm-4">
			<?= $form->field($model,'subject')->textInput(['maxlength' => true])->label('') ?>			</div>
		</div><!--/form-group-->
				
			 <div class="form-group">
		   <label class="col-sm-2 control-label">Body</label>
           <div class="col-sm-4">
			<?= $form->field($model,'body')->textInput(['maxlength' => true])->label('') ?>			</div>
		</div><!--/form-group-->
