...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create transaction-types</h3>
            </div>
            <div class="porlets-content">
            <form  name="transaction-types-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Trans code</label>
                  	<div class="col-sm-9"><input type="text" name="trans_code" ng-model="transaction-types.trans_code"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Transaction description</label>
                  	<div class="col-sm-9"><input type="text" name="transaction_description" ng-model="transaction-types.transaction_description"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Transaction narrative</label>
                  	<div class="col-sm-9"><input type="text" name="transaction_narrative" ng-model="transaction-types.transaction_narrative"class="form-control"></div>
                	</div><!--/form-group-->
