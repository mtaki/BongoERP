...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create loan-calc-method</h3>
            </div>
            <div class="porlets-content">
            <form  name="loan-calc-method-form" class="form-horizontal row-border">
			...
			<div class="form-group">
                  	...
                  	<div class="col-sm-9">
					<input type="text" name="method" class="form-control"></div>
                	</div><!--/form-group-->
 ...
 <?php $form = ActiveForm::begin(); ?>
		...
		<div class="form-group">
           ...
           <div class="col-sm-9">
				...
				<?= $form->field($model,'method')->textInput(['maxlength' => true])->label('') ?>
           ...
           <div class="col-sm-9">
				...
				<?= $form->field($model,'Descreption')->textInput(['maxlength' => true])->label('') ?>
