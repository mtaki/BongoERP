...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create zone</h3>
            </div>
            <div class="porlets-content">
            <form  name="zone-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Zone id</label>
                  	<div class="col-sm-9"><input type="text" name="zone_id" ng-model="zone.zone_id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Zone name</label>
                  	<div class="col-sm-9"><input type="text" name="zone_name" ng-model="zone.zone_name"class="form-control"></div>
                	</div><!--/form-group-->
