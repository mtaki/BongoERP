...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create vendor-type</h3>
            </div>
            <div class="porlets-content">
            <form  name="vendor-type-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Id</label>
                  	<div class="col-sm-9"><input type="text" name="id" ng-model="vendor-type.id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Vendor type</label>
                  	<div class="col-sm-9"><input type="text" name="Vendor_type" ng-model="vendor-type.Vendor_type"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Vendor description</label>
                  	<div class="col-sm-9"><input type="text" name="vendor_description" ng-model="vendor-type.vendor_description"class="form-control"></div>
                	</div><!--/form-group-->
