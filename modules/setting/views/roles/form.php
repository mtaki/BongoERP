...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create roles</h3>
            </div>
            <div class="porlets-content">
            <form  name="roles-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Id</label>
                  	<div class="col-sm-9"><input type="text" name="id" ng-model="roles.id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Name</label>
                  	<div class="col-sm-9"><input type="text" name="name" ng-model="roles.name"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Role</label>
                  	<div class="col-sm-9"><input type="text" name="role" ng-model="roles.role"class="form-control"></div>
                	</div><!--/form-group-->
