...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create regions</h3>
            </div>
            <div class="porlets-content">
            <form  name="regions-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Region Id</label>
                  	<div class="col-sm-9"><input type="text" name="Region_Id" ng-model="regions.Region_Id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Region Name</label>
                  	<div class="col-sm-9"><input type="text" name="Region_Name" ng-model="regions.Region_Name"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Zone id</label>
                  	<div class="col-sm-9"><input type="text" name="zone_id" ng-model="regions.zone_id"class="form-control"></div>
                	</div><!--/form-group-->
