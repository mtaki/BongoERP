...
$this->params['breadcrumbs'][] = ['label' => $model->tran_type_id, 'url' => ['view', 'id' => $model->tran_type_id]];
...
<div class="contentpanel">
	...
	<div class="transaction-type-index">
		...
		<p><?= Html::a(Yii::t('app', 'Create Transaction Type'), ['create'], ['class' => 'btn btn-success']) ?></p>
