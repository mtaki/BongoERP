...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
            ...
            <form  name="account-transaction-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Document no</label>
                  	<div class="col-sm-9">
					<input type="text" name="Document_no" class="form-control"></div>
                	</div><!--/form-group-->
			...
			<div class="form-group">
                  	...
                  	<div class="col-sm-9">
					<input type="text" name="Entered_by" class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Aproved by</label>
                  	<div class="col-sm-9">
					<input type="text" name="Aproved_by" class="form-control"></div>
                	</div><!--/form-group-->
 ...
 <?php $form = ActiveForm::begin(); ?>
           ...
           <div class="col-sm-9">
				...
				<?= $form->field($model,'Entered_by')->textInput(['maxlength' => true])->label('') ?>
           ...
           <div class="col-sm-9">
				...
				<?= $form->field($model,'Aproved_by')->textInput(['maxlength' => true])->label('') ?>
