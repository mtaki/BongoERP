...
/* @var $searchModel app\modules\setting\models\AccountPostingTypeSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'Account Posting Types');
...
<div class="account-posting-type-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Create Account Posting Type'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
