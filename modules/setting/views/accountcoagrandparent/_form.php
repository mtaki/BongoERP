...
<?php $form = ActiveForm::begin(["class"=>"form-horizontal row-border"]); ?>
           ...
           <div class="col-sm-4">
			<?= $form->field($model,'account_grand_parent_code')->textInput(['maxlength' => true])->label('') ?>			</div>
		</div><!--/form-group-->
				
			 <div class="form-group">
		   <label class="col-sm-2 control-label">Coa grand parent sub cat id</label>
           <div class="col-sm-4">
			<?= $form->field($model,'coa_grand_parent_sub_cat_id')->textInput(['maxlength' => true])->label('') ?>			</div>
		</div><!--/form-group-->
				
			 <div class="form-group">
		   <label class="col-sm-2 control-label">Grand parent name</label>
           <div class="col-sm-4">
			<?= $form->field($model,'grand_parent_name')->textInput(['maxlength' => true])->label('') ?>			</div>
		</div><!--/form-group-->
