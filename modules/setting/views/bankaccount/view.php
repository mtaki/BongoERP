...
$this->title = $model->gl_account_affecting;
...
<div class="bank-account-view">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Update'), ['update', 'id' => $model->gl_account_affecting], ['class' => 'btn btn-primary']) ?>
        <?= Html::a(Yii::t('app', 'Delete'), ['delete', 'id' => $model->gl_account_affecting], [
