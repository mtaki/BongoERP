...
<div class="contentpanel">
      ...
      <div class="row">
		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
              <h3 class="content-header">Create user-menu</h3>
            </div>
            <div class="porlets-content">
            <form  name="user-menu-form" class="form-horizontal row-border">


					<div class="form-group">
                  	<label class="col-sm-3 control-label">Id</label>
                  	<div class="col-sm-9"><input type="text" name="id" ng-model="user-menu.id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Menu code</label>
                  	<div class="col-sm-9"><input type="text" name="menu_code" ng-model="user-menu.menu_code"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Menu name</label>
                  	<div class="col-sm-9"><input type="text" name="Menu_name" ng-model="user-menu.Menu_name"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Menu category</label>
                  	<div class="col-sm-9"><input type="text" name="menu_category" ng-model="user-menu.menu_category"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Menu link</label>
                  	<div class="col-sm-9"><input type="text" name="menu_link" ng-model="user-menu.menu_link"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">Linked role</label>
                  	<div class="col-sm-9"><input type="text" name="linked_role" ng-model="user-menu.linked_role"class="form-control"></div>
                	</div><!--/form-group-->
