		...
		<a class="close-down" href="#"><i class="fa fa-times"></i></a> </div>
            ...
            <form  name="user-group-form" class="form-horizontal row-border">
					...
					<div class="form-group">
                  	...
                  	<div class="col-sm-9"><input type="text" name="group_id" ng-model="user-group.group_id"class="form-control"></div>
                	</div><!--/form-group-->
			

			<div class="form-group">
                  	<label class="col-sm-3 control-label">User id</label>
                  	<div class="col-sm-9"><input type="text" name="user_id" ng-model="user-group.user_id"class="form-control"></div>
                	</div><!--/form-group-->
