      ...
      <div class="row">
		...
		<?php foreach ($generator->getColumnNames() as $attribute):?>
			<div class="form-group">
                  	...
                  	<div class="col-sm-9"><input type="text" name="<?php echo $attribute;?>" ng-model="<?= Inflector::camel2id(StringHelper::basename($generator->modelClass)).".".$attribute ?>"class="form-control"></div>
                	</div><!--/form-group-->
			<?php 
			echo "\n\n";;
			endforeach;?>
